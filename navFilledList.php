                ...
                <tr>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php   } ?>
                            <td><?php echo $setNumber; ?></td><!--set number -->
    ...
    <!----------------------------if exTypeID is 1(create an columns for weight and reps for each set(row)---------------------------------------->
                                   ...
                                   <table cellpadding="2" cellspacing="2" border="1">
                                       <tr><th>weight</th><th>reps</th></tr>
                                           ...
                                           <tr><td><input type="text" id="<?php echo $weightInput;?>" name="<?php echo $weightInput;?>" value="<?php echo $basket[$bi][7];?>"></td><td><input type="text" id="<?php echo $repCountInput;?>" name="<?php echo $repCountInput;?>"  value="<?php echo $basket[$bi][6];?>"></td></tr>
    ...
    <!-----------------------------if exTypeID is 2(create one column for duration of each set(row)----------------------------------------------->
                                   ...
                                   <table cellpadding="2" cellspacing="2" border="1">
                                       <tr><th>time</th></tr>
                                           ...
                                           <tr><td><input type="text" id="<?php echo $timeInput;?>" name="<?php echo $timeInput;?>" value="<?php echo $basket[$bi][5];?>"></td></tr>
                             <!--                         Finding out the names of the input boxes                                          -->                                      
                                                            <?php/**   echo '<script language="javascript">';
    ...
    <!-------------------------------if exTypeID is 4(create one column for count of each set(row)------------------------------------------------->
                                   ...
                                   <table cellpadding="2" cellspacing="2" border="1">
                                       <tr><th>count</th></tr>
                                           ...
                                           <tr><td><input type="text" id="<?php echo $repCountInput;?>" name="<?php echo $repCountInput;?>" value="<?php echo $basket[$bi][6];?>"></td></tr>
                             <!--                         Finding out the names of the input boxes                                          -->                                      
                                                            <?php/**   echo '<script language="javascript">';
