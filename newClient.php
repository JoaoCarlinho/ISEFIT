...
if(isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['nickName']) && isset($_POST['dob']) && isset($_POST['zip']) && isset($_POST['email']) && isset($_POST['mobile']) && isset($_POST['auCode']) && isset($_POST['auCodeConfirm'])){
    ...
    if(!preg_match($email_exp , $newEmail)) {
            ...
            /***************************************determine if there is an client stored with same email******************************************/
                    ...
                    if($count != 0){
                                    ...
                                    $message = 'Someone is already being spotted wth the email you submitted.';
                                    header("Location: clientRegistration.php?message=$message");
                    }
    }
    $mobile = $_POST['mobile'];
