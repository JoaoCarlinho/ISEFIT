...
<html lang="en-us">
    <head>
        <meta charset="utf-8">
        <title>Login to Optimizer</title>  
    </head>
    <body>
        <?php 
        include 'header.php';
...
?>
        <div class="main">
            ...
            <div class="customerLoginBox"><br/>
                    <span id="status"></span>
                    <div id="signUpInfo">
                            <form method="post" name="signupForm" action="clientPasswordUpdate.php" style="width:300px;">                       
                                <table>
                                        <tr>
                                            <td>
...
<?php    
    ...
    $db = connect();
        ...
        if($count == 1){
            ...
            include('clientPasswordUpdateEmail.php');
        }else{
        ...
        if(n < 10 || n >30){
            ...
            //make sure no semicolons, quotes, slashes, greater than, less than or dashes can be used as part of a password on ajaxRegistration form
             _("passwordAlerts1").innerHTML = '<strong style="color:#F00;">password must not contain any of the following characters:<br/> \' " ; \ / < > - =</strong>';
                ...
                var ajax = ajaxObj("POST", "clientPasswordUpdate.php");
